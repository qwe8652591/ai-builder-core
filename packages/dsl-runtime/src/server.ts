...
function generateEntryContent(config: DSLProjectConfig): string {
  ...
  return `
/**
 * 🎯 Auto-generated by DSL Runtime
 * 这是由 dsl-runtime 自动生成的入口文件
 */
  ...
  React.useEffect(() => {
    async function init() {
      try {
        ...
        console.log('📊 DSL Metadata Statistics:', stats);
...
export async function createDevServer(config: DSLProjectConfig): Promise<ViteDevServer> {
  ...
  console.log(`📝 Using runtime entry from dsl-runtime package`);
